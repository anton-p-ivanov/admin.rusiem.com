...
const title: TFormField<string> = {
  name: 'title',
  label: 'Название',
  hint: 'Введите название публикации или его часть',
  defaultValue: '',
};
...
const site: TFormField<string> = {
  ...
  name: 'site',
  label: 'Сайт',
  hint: 'Выберите сайт, на котором опубликована публикация',
  defaultValue: '',
  attrs: {
...
const locale: TFormField<string> = {
  ...
  name: 'locale',
  label: 'Язык',
  hint: 'Выберите язык, на котором написана публикация',
  defaultValue: '',
  attrs: {
...
const isPublished: TFormField<string> = {
  type: 'choices',
  name: 'isPublished',
  label: 'Показывать опубликованные публикации',
  defaultValue: 'false',
  attrs: {
    isInline: true,
    choices: [
